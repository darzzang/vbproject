...
$(document).ready(function() {
	...
	var navList3 = url.indexOf("bookingCheck");
  ...
  <div class="container">
    ...
    <div class="d-flex">
    	<ul class="navbar-nav me-auto">
    		...
    		<li class="nav-item" id="navBookingChk"><a class="nav-link" href="/bookingCheck.jsp">예약 조회</a></li>
