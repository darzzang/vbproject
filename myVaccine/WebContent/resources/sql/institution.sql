...
/* 테스트를 위한 데이터 입력 */
insert into institution values('2021-09-03', '대구광역시', '동구', '검사동', '1005-8', '동구보건소','053-662-3201','평일 09:00 - 18:00. 주말 및 공휴일 휴무');
insert into institution values('2021-09-03', '대구광역시', '동구', '효목동', '1084', '동구 예방접종센터','053-951-3300','평일 09:00 - 18:00. 주말 및 공휴일 휴무');

/* institution table + vaccine table */
